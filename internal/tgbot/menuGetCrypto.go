...
// 	// if len(crypto) == 1 {
// 	row = append(row, tgbotapi.NewInlineKeyboardButtonData("Установить отслеживание", SetNotif+"_"+crypto.CryptoName))
// 	// } else {
...
// 		btn := tgbotapi.NewInlineKeyboardButtonData(v.CryptoName, prefix+"Curr_"+strconv.Itoa(v.CryptoId))
// 		row = append(row, btn)
...
// 	if offset > 10 {
// 		row = append(row, tgbotapi.NewInlineKeyboardButtonData("Назад", prefix+`Back_`+strconv.Itoa(offset-10)))
// 	} else {
// 		row = append(row, tgbotapi.NewInlineKeyboardButtonData("Назад", prefix+`Back`))
// 	}

// 	if !lastList {
// 		row = append(row, tgbotapi.NewInlineKeyboardButtonData("Ещё", prefix+`Next_`+strconv.Itoa(offset+10)))
// 	}
// 	// row = append(row, tgbotapi.NewInlineKeyboardButtonData("Ввод", GetCryptoEnter))
// 	keyboard.InlineKeyboard = append(keyboard.InlineKeyboard, row)
